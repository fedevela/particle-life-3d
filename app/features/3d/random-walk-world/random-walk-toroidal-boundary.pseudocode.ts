...
export type RequirementLogicObligation = {
  ...
  obligation: string;
  owningPseudocodeLocus: "app/features/3d/random-walk-world/random-walk-toroidal-boundary.pseudocode.ts";
...
export type Issue32PseudocodeLocus = {
  ...
  owner: "app/features/3d/random-walk-world/random-walk-toroidal-boundary.pseudocode.ts";
